...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testDiscoveryName, "token_endpoint", issuerUrl+"/token"),
					resource.TestCheckResourceAttr(testDiscoveryName, "jwks_uri", issuerUrl+"/keys"),
					resource.TestCheckResourceAttr(testDiscoveryName, "userinfo_endpoint", issuerUrl+"/userinfo"),
					resource.TestCheckResourceAttr(testDiscoveryName, "device_authorization_endpoint", issuerUrl+"/device/code"),
					resource.TestCheckResourceAttr(testDiscoveryName, "introspection_endpoint", issuerUrl+"/token/introspect"),
